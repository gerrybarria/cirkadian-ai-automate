      ...
      <div className="max-w-7xl mx-auto px-6 py-4">
        <div className="flex items-center justify-between">
          ...
          <div className="hidden md:flex items-center space-x-8">
            ...
            <a href="#industries" className="text-gray-300 hover:text-blue-400 transition-colors">Industries</a>
            <a href="#testimonials" className="text-gray-300 hover:text-blue-400 transition-colors">Reviews</a>
            <Button 
              className="bg-gradient-to-r from-blue-600 to-purple-600 hover:from-blue-700 hover:to-purple-700 text-white hover-scale border-0"
