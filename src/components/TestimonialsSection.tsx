...
export const TestimonialsSection = () => {
  return <section id="testimonials" className="py-20 px-6 bg-black">
      <div className="max-w-7xl mx-auto">
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
          {testimonials.map((testimonial, index) => <Card key={index} className="bg-white border-gray-200 hover:border-gray-300 transition-all duration-300 group hover-scale">
